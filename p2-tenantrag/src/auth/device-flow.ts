...
/** Completes Device Flow polling, including the protocol's backoff signals. */
...
export function parsePersona(value: string | undefined): PersonaId {
  if (value === "ada" || value === "leo" || value === "mallory") return value;
  throw new Error("Choose one P2 account: ada, leo, or mallory");
}
